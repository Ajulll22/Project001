...
<script>
    ...
    function buildTableBody(data){
        ...
        data.participants.forEach((element, index) => {
            ...
            const now = new Date();
            let umur = now.getMonth() - birthday.getMonth();
                    ...
                    <table id="table-participant" class="table table-striped w-100">
                        <thead>
                            <tr>
                                ...
                                <th width="5%">Umur (Bln)</th>
                                <th width="23%">Nama Orang Tua</th>
                                <th width="5%">BB (Kg)</th>
                                <th width="5%">TB (Kg)</th>
                                <th width="20%">Imunisasi</th>
                            </tr>
                        </thead>
...
<div class="mt-3" hidden>
    <div id="print-area">
        <h4 style="text-align: center; margin-bottom: 30px">DAFTAR HADIR BALITA YANG DATANG KE POSYANDU <br> KECAMATAN LABUHAN RATU 2023</h4>
